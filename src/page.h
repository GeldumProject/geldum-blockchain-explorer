...
public:
                    ...
                    bool tx_prove = false)
    {
        ...
        // parse string representing given geldum address
...
//                                << endl;
    ...
    search(string search_text)
    {
        ...
        // check if geldum address is given based on its length
        ...
        // check if integrated geldum address is given based on its length
 ...
 */
                 ...
                 bool tx_prove = false)
    {
        ...
        {
            j_response["status"]  = "error";
            j_response["message"] = "Cant parse geldum address: " + address_str;
            return j_response;
                       ...
                       bool in_mempool_aswell = false)
    {
        ...
        {
            j_response["status"]  = "error";
            j_response["message"] = "geldum address not provided";
            return j_response;
        }
